...
$packageNameLower = 'migxcalendars';
 /* No spaces, no dashes */
...
$default = array(
    ...
    'packageDescription' => 'migxCalendars project for MyComponent extra',
    'version' => '1.0.0',
    'release' => 'beta1',
    'author' => 'Bruno Perner',
    'email' => 'b.perner@gmx.de',
    'authorUrl' => 'http://www.webcmsolutions.de',
    'authorSiteName' => "webcmsolutions.de",
    ...
    'gitHubUsername' => 'Bruno17',
    'gitHubRepository' => 'migxCalendars',
    ...
    'mycomponentRoot' => $modx->getOption('mc.root', null, MODX_CORE_PATH . 'components/mycomponent/'),
    /* path to MyComponent source files */
    'mycomponentCore' => $modx->getOption('mc.core_path', null, MODX_CORE_PATH . 'components/mycomponent/core/components/mycomponent/'),
    /* path to new project root */
    'targetRoot' => MODX_ASSETS_PATH . 'mycomponents/' . $packageNameLower . '/',

    'workingDirs' => array(
        'core' => MODX_CORE_PATH . 'components/' . $packageNameLower . '/',
        'assets' => MODX_ASSETS_PATH . 'components/' . $packageNameLower . '/',
        ),
    ...
    */
    ...
    'namespaces' => array('migxcalendars' => array(
            'name' => 'migxcalendars',
            'path' => '{core_path}components/migxcalendars/',
            'assets_path' => '{assets_path}components/migxcalendars/',
            ), ),
