...
if ($object) {
    ...
    if ($type == 'repeating') {
        ...
        if ($event_object) {
            ...
            $event_object->set('startdate', strftime('%Y-%m-%d %H:%M:%S', strtotime($event_object->get('startdate')) + $movedelta));
            $event_object->set('enddate', strftime('%Y-%m-%d %H:%M:%S', strtotime($event_object->get('startdate')) + $datedelta));
            //$object->set('repeatenddate',$repeatenddate);
